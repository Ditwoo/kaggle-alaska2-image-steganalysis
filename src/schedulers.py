...
# TODO: Schedulers from:
# TODO:     https://github.com/drivendataorg/hakuna-madata/blob/master/2nd%20Place/thunder-hammer/thunder_hammer/scheduler.py
...
class CosineAnnealingWithRestartsLR(_LRScheduler):
    ...
    def __init__(self, optimizer: Optimizer, T_max, eta_min=0, last_epoch=-1, T_mult=1):
        self.T_max = T_max
        self.T_mult = T_mult
